		...
		<div class="container-fluid">
			<div id="pad-wrapper">
				<div class="table-products">
					<form id="SearchForm" name="SearchForm" class="" method="get" action="${contextPath}/infototalorder/infototalorderlist.htm">
						<div class="row-fluid header">
							<h4>
								<legend>
									第三方支付交易关联表管理
									<small>管理平台的第三方支付交易关联表管理</small>
								</legend>
							</h4>
							<div class="pull-right">
								...
								&nbsp;
								<a class="btn-flat success pull-right" href="${contextPath}/infototalorder/infototalorderedit.htm">
									<span>&#43;</span> 新增
								</a>
							</div>
						</div>
							...
							<table class="table table-hover table-striped">
								<thead>
									<tr>
										...
										<th class="span2">
											<span class="line"></span>交易id
										</th>
										<th class="span2">
											<span class="line"></span>类型：0-itemid；1-tradeid；
										</th>
									...
									<c:forEach items="${page.result}" varStatus="status" var="v">
										<tr>
											...
											<td class="align-right">
												<a href="${contextPath}/infototalorder/infototalorderedit.htm?seq=${v.seq}" class="btn-flat default">修改</a>
...
<script type="text/javascript">
	...
	function doDel(id, index) {
		if (confirm("确认删除？")) {
			ajax_get("${contextPath}/infototalorder/infototalorderdelete.htm", "&seq=" + id, function(data) {
