		...
		<div class="container-fluid">
			<div id="pad-wrapper">
				<div class="table-products">
					<form id="SearchForm" name="SearchForm" class="" method="get" action="${contextPath}/logtoken/logtokenlist.htm">
						<div class="row-fluid header">
							<h4>
								<legend>
									token表管理
									<small>管理平台的token表管理</small>
								</legend>
							</h4>
							<div class="pull-right">
								...
								&nbsp;
								<a class="btn-flat success pull-right" href="${contextPath}/logtoken/logtokenedit.htm">
									<span>&#43;</span> 新增
								</a>
							</div>
						</div>
									...
									<c:forEach items="${page.result}" varStatus="status" var="v">
										<tr>
											...
											<td class="align-right">
												<a href="${contextPath}/logtoken/logtokenedit.htm?seq=${v.seq}" class="btn-flat default">修改</a>
...
<script type="text/javascript">
	...
	function doDel(id, index) {
		if (confirm("确认删除？")) {
			ajax_get("${contextPath}/logtoken/logtokendelete.htm", "&seq=" + id, function(data) {
