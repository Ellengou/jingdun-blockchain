		...
		<div class="container-fluid">
			<div id="pad-wrapper" class="new-user">
				<div class="span9" id="content">
					<div class="row-fluid">
						<form id="editForm" modelAttribute="logpasswd" action="" method="post" class="form-horizontal inline-input">
							<input type="hidden" id="seq" name="seq" value="${logpasswd.seq}" />
							<fieldset>
								<legend>编辑密码修改日志</legend>
								<div class="control-group">
									<label class="control-label" for="focusedInput">注册用户名（实际是手机号）：</label>
									<div class="controls">
										<input id="username" name="username" class="input-xlarge focused inline-input" placeholder="" id="focusedInput" type="text" maxlength="20" value="${logpasswd.username}" />
...
<script language="javascript">
	...
	function doSave() {
		...
		ajax_get("${contextPath}/logpasswd/logpasswdsave.htm", $("#editForm").serialize(), function(data) {
			if (data.errorMessage) {
				showmsg(0, data.errorMessage);
			} else {
				showmsg(1, "处理成功!");
				window.setTimeout("location.href='${contextPath}/logpasswd/logpasswdlist.htm'", 1500);
			}
		});
	}
</script>