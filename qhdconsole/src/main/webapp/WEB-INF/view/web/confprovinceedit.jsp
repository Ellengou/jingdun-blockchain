		...
		<div class="container-fluid">
			<div id="pad-wrapper" class="new-user">
				<div class="span9" id="content">
					<div class="row-fluid">
						<form id="editForm" modelAttribute="confprovince" action="" method="post" class="form-horizontal inline-input">
							<input type="hidden" id="id" name="id" value="${confprovince.id}" />
							<fieldset>
								<legend>编辑省级地区表</legend>
								<div class="control-group">
									<label class="control-label" for="focusedInput">省id：</label>
									<div class="controls">
										<input id="provinceid" name="provinceid" class="input-xlarge focused inline-input" placeholder="" id="focusedInput" type="text" maxlength="20" value="${confprovince.provinceid}" />
										<span class="red ml5">*</span>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="focusedInput">省名称：</label>
									<div class="controls">
										<input id="provincename" name="provincename" class="input-xlarge focused inline-input" placeholder="" id="focusedInput" type="text" maxlength="40" value="${confprovince.provincename}" />
										<span class="red ml5">*</span>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input id="orderby" name="orderby" class="input-xlarge focused inline-input" placeholder="" id="focusedInput" type="text" maxlength="20" value="${confprovince.orderby}" />
										<span class="red ml5">*</span>
									</div>
								</div>
								<div class="control-group">
...
<script language="javascript">
	...
	function doSave() {
		clearerr();
		var ids = [ 'provinceid','provincename','orderby' ];
		if (check_required(ids)) {
			return;
		}
		ajax_get("${contextPath}/confprovince/confprovincesave.htm", $("#editForm").serialize(), function(data) {
			if (data.errorMessage) {
				showmsg(0, data.errorMessage);
			} else {
				showmsg(1, "处理成功!");
				window.setTimeout("location.href='${contextPath}/confprovince/confprovincelist.htm'", 1500);
			}
		});
	}
</script>