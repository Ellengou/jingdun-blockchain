		...
		<div class="container-fluid">
			<div id="pad-wrapper">
				<div class="table-products">
					<form id="SearchForm" name="SearchForm" class="" method="get" action="${contextPath}/infopayconfig/infopayconfiglist.htm">
						<div class="row-fluid header">
							<h4>
								<legend>
									绑定帐户信息管理
									<small>管理平台的绑定帐户信息管理</small>
								</legend>
							</h4>
							<div class="pull-right">
								...
								&nbsp;
								<a class="btn-flat success pull-right" href="${contextPath}/infopayconfig/infopayconfigedit.htm">
									<span>&#43;</span> 新增
								</a>
							</div>
						</div>
							...
							<table class="table table-hover table-striped">
								<thead>
									<tr>
										...
										<th class="span2">
											<span class="line"></span>绑定类型：0-CNY；1-USD
										</th>
										<th class="span2">
											<span class="line"></span>账号号
										</th>
										<th class="span2">
											<span class="line"></span>开户姓名
										</th>
									...
									<c:forEach items="${page.result}" varStatus="status" var="v">
										<tr>
											...
											<td class="align-right">
												<a href="${contextPath}/infopayconfig/infopayconfigedit.htm?seq=${v.seq}" class="btn-flat default">修改</a>
...
<script type="text/javascript">
	...
	function doDel(id, index) {
		if (confirm("确认删除？")) {
			ajax_get("${contextPath}/infopayconfig/infopayconfigdelete.htm", "&seq=" + id, function(data) {
