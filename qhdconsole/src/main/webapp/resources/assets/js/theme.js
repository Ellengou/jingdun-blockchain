$(function() {
	...
	//		$("#dashboard-menu li .submenu").slideUp("fast");
	//		if (status == 1) {
	...
	$("#dashboard-menu li #home-menu").click(function() {
		$("#dashboard-menu li").removeClass("active");
		$("#dashboard-menu li .submenu").hide();
		$("#dashboard-menu li .pointer").hide();
		$(this).parent().find(".pointer").slideDown("fast");
	});
	$("#dashboard-menu .submenu li").click(function() {
		$("#dashboard-menu .submenu li a").removeClass("active");
		$(this).find("a").addClass("active");
		$("#dashboard-menu li .pointer").hide();
		$(this).parent().parent().find(".pointer").slideDown("fast");
	});
