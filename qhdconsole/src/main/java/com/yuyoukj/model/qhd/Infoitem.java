...
public class Infoitem implements Serializable {
	...
	private Integer sflag; // 状态：0-正常；1-超时系统取消；2-用户主动取消；11-已删除；; 0; 20;
	private Integer sstatus; // 0-等待转账；3-完成；98-登记；99-登记并转帐；96-超时系统取消未退款；97-超时系统取消已退款； 94-用户主动取消未退款；95-用户主动取消已退款；; 0; 20;
	private String createdate; // ; 0; 20;
