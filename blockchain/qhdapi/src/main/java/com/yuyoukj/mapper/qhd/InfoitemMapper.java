...
public interface InfoitemMapper {
	...
	public List<Infoitem> getInfoitemList_simple(Map<String, Object> pmap);

	public List<Infoitem> getInfoitemList_trade(Map<String, Object> pmap);

	public Integer getInfoitemList_simplecount(Map<String, Object> pmap);

	public Integer getInfoitemList_tradecount(Map<String, Object> pmap);
