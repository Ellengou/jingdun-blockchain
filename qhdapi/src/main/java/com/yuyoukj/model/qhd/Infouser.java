...
public class Infouser implements Serializable {
	...
	private Long registerdate; // 注册时间; 0; 20;
	private String payconfig; // 以","分隔，如：0,1; 0; 20;
	private Long createdate; // ; 0; 20;
	private Long updatedate; // ; 0; 20;
	private List<Infopayconfig> payconfiglist;

	public List<Infopayconfig> getPayconfiglist() {
		return payconfiglist;
	}

	public void setPayconfiglist(List<Infopayconfig> payconfiglist) {
